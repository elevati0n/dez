...
Refinery::Pages.configure do |config|
  ...
  # config.friendly_id_reserved_words = ["index", "new", "session", "login", "logout", "users", "refinery", "admin", "images", "landings", "locations", "jobs", "bids", "cars", "drivers", "password", "edit", "dashboard", "signout", "signup", "account"]
